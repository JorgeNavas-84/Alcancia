...
public class Alcancia {
    ...
    public int obtenerDenominacionMasNumerosa() {
        int denominacionMasNumerosa = numeroMonedas50;
        int darDenominacionMasNumerosa = 50;
        if (denominacionMasNumerosa < numeroMonedas100){
            denominacionMasNumerosa = numeroMonedas100;
            darDenominacionMasNumerosa =100;
        }
        if (denominacionMasNumerosa < numeroMonedas200){
            denominacionMasNumerosa = numeroMonedas200;
            darDenominacionMasNumerosa =200;
        }
        if (denominacionMasNumerosa < numeroMonedas500){
            denominacionMasNumerosa = numeroMonedas500;
            darDenominacionMasNumerosa =500;
        }
        if (denominacionMasNumerosa < numeroMonedas1000){
            denominacionMasNumerosa = numeroMonedas1000;
            darDenominacionMasNumerosa =1000;
        }
        return darDenominacionMasNumerosa;
    }
